...
const ViewProvider = () => {
  ...
  const handleEdit = () => {
    // Redirect to edit provider page - this would need to be implemented
    navigate(`/admin/health-providers/edit/${id}`);
  };
  ...
  const handleDelete = async () => {
    try {
      ...
      navigate('/admin/health-providers', { 
        state: { success: 'Provider deleted successfully' } 
      });
    } catch (err) {
  ...
  const handleViewAsProvider = () => {
    // In a real implementation, this would use a special admin feature to impersonate a provider
    // For now, we'll just navigate to the route to simulate this functionality
      ...
      {showDeleteModal && (
        ...
        >
          <div className={styles.modalContent}>
            <p>Are you sure you want to delete this health provider account?</p>
            <p className={styles.warningText}>
              This action cannot be undone and will remove all data associated with this provider.
            </p>
            <div className={styles.modalActions}>
              ...
              <Button
                ...
                disabled={processing}
              >
                {processing ? 'Deleting...' : 'Delete Provider'}
              </Button>
            </div>
          </div>
        </Modal>
